			...
			<table class="table table-bordered" id="prodcTable">
				<tbody>
					<tr class="titleName">
						<th class="pdName">상품명
						<td class="nameSp">
						<input type="text" name="isProductName" class="txtName" value="${inoutlist.name}" readonly>
					...
					<tr class="titleGroup">
						...
						<td class="gpSp"><input type="text" name="productseq"
							class="txtNum" value="${inoutlist.productseq}" readonly></td>
						</th>
					</tr>
					...
					<tr class="titleNum">
						...
						<td class="numSp"><input type="text" name="isProductNum"
							class="txtNum" value="${inoutlist.product }" readonly></td>
						</th>
					</tr>
					...
					<tr class="titlePrice">
						...
						<td class="priceSp"><input type="date" name="regdate" id="currentDate"
							class="txtPr" value="${inoutlist.date }"></td>
						</th>
					</tr>
					...
					<tr class="titleExp">
						...
						<td class="expSp"><input type="text" name="qty"
							class="txtPr" value="${inoutlist.qty }"></textarea></td>
						</th>
					</tr>
