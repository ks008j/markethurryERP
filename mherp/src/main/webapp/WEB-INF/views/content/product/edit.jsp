...
<div id="container">
    ...
    <div class="prodcBody">
    	...
    	<form method="POST" action="/mherp/product/editok.action">
        ...
        <table class="table table-bordered" id="prodcTable">
            <tbody>
               ...
               <tr class="titleNum">
                     ...
                     <td class="numSp">
                         <input type="text" name="seq" class="txtNum" value="${dto.seq}">
                     </td>
                </tr>
                ...
                <tr class="titleName">
                    ...
                    <td class="nameSp">
                        <input type="text" name="name" class="txtName" value="${dto.name}">
                    </td>
                </tr>
                ...
                <tr class="titlePrice">
                     ...
                     <td class="priceSp">
                         <input type="text" name="price" class="txtPr" value="${dto.price}"> 원
                     </td>
                 ...
                 <tr class="titleExp">
                     ...
                     <td class="expSp">
                         <textarea  name="shortdesc" class="txtExp">${dto.shortdesc}</textarea>
                     </td>
                 ...
                 <tr class="titleDtExp">
                     ...
                     <td class="dtExpSp">
                         <textarea  name="content" class="txtDtExp">${dto.content}</textarea>
                     </td>
                 </tr>
